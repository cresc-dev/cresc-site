...
See [Expo pricing vs Cresc](/expo-pricing-vs-cresc.md). As checked on April 17, 2026, Expo EAS Update and Cresc use different meters: Expo bills around update MAUs and bandwidth, while Cresc uses fixed monthly tiers based on daily update checks. Cresc keeps capacity planning explicit: pick the tier that fits real traffic, then upgrade when the app needs more headroom instead of absorbing automatic overage bills.
