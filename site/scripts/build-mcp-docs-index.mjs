#!/usr/bin/env node
/**
 * Emit out/mcp-docs-index.json — the corpus the Cresc MCP documentation tools
 * search and serve.
 *
 * The index ships as a static asset of this site
 * (https://cresc.dev/mcp-docs-index.json) and is fetched by the
 ...
 *
 * Plain ESM on purpose: it must run under whatever the deploy workflow has,
 * which is node here and bun in the sibling site.
 *
...
const RESOURCE_SCHEME = 'cresc-docs';
