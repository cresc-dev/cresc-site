...
> These are screenshots of the real local Cresc console. Atlas Travel, its releases and all metrics are fictional demonstration data, not customer results or performance promises. Click any screenshot to open the original.
...
In the sample, version 4.8.1 has a higher rollback rate than 4.8.2. Filter that release, compare its native packages, and move to Failures to investigate its errors.
