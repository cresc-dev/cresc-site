...
- **Client requirement**: the native package must ship `react-native-update` >= 10.52.1 (older clients lack the full native cold-start check capability, and the console hides the option for them)
